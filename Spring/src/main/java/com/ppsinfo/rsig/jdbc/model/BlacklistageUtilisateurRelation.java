...
public class BlacklistageUtilisateurRelation extends BasicData {
	...
	public BlacklistageUtilisateurRelation() {
		super();
	...
	public BlacklistageUtilisateurRelation(int id, int id_utilisateur, int id_source) {
		this();
		this.id = id;
